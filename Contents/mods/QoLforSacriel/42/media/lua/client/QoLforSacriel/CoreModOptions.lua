...
function CoreModOptions.register(logger)
    ...
    options:addTitle("UI_QoLforSacriel_Modules_MainTitle")
    ...
    options:addTickBox("enableSoundDirection", "UI_QoLforSacriel_Modules_EnableSoundDirection", false, "UI_QoLforSacriel_Modules_EnableSoundDirection_Tooltip")
    options:addDescription("UI_QoLforSacriel_Modules_SoundDirectionNote")
    options:addTickBox("enableNoiseRadius", "UI_QoLforSacriel_Modules_EnableNoiseRadius", false, "UI_QoLforSacriel_Modules_EnableNoiseRadius_Tooltip")
    ...
    options:addTickBox("showExactSleepStats", "UI_QoLforSacriel_Modules_ShowExactSleepStats", false, "UI_QoLforSacriel_Modules_ShowExactSleepStats_Tooltip")
    ...
    options:addTickBox("enableForagingVisionTooltip", "UI_QoLforSacriel_Modules_EnableForagingVisionTooltip", true, "UI_QoLforSacriel_Modules_EnableForagingVisionTooltip_Tooltip")
    options:addTickBox("enableForagingClothingPenaltyFix", "UI_QoLforSacriel_Modules_EnableForagingClothingPenaltyFix", false, "UI_QoLforSacriel_Modules_EnableForagingClothingPenaltyFix_Tooltip")
    ...
    options:addTickBox("furnitureNudgeKeepInventoryExperimental", "UI_QoLforSacriel_Modules_FurnitureNudgeKeepInventoryExperimental", false, "UI_QoLforSacriel_Modules_FurnitureNudgeKeepInventoryExperimental_Tooltip")
