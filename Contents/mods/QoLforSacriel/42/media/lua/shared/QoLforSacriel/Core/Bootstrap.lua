...
local function registerModules()
    ...
    if foragingClothingPenaltyFix and foragingClothingPenaltyFix.init then
        registry.register("ForagingClothingPenaltyFix.Base", "QoLforSacriel_EnableMod", foragingClothingPenaltyFix.init)
    end
    if organizedInventory and organizedInventory.init then
        registry.register("OrganizedInventory.Base", "QoLforSacriel_EnableOrganizedInventory", organizedInventory.init)
    end
