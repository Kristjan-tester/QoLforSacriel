...
local defaults = {
    ...
    QoLforSacriel_FurnitureNudge_KeepInventoryExperimental = true,
...
local MOD_OPTION_KEY_BY_SETTING = {
    ...
    QoLforSacriel_FurnitureNudge_KeepInventoryExperimental = "furnitureNudgeKeepInventoryExperimental",
